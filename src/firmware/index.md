...
Guide: [Flashing with Web Tools](./web_tools.md)
...
Guide: [Flashing with Local Setup](./local.md)

## Firmware Internals (Optional)

If you want to understand or modify the firmware, see:

- [Firmware details](./details.md)
